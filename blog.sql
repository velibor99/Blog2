...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2021 at 09:01 AM
...
INSERT INTO `bad_words` (`id`, `word`, `kind`) VALUES
(1, 'Debil', 1),
(2, 'Idiot', 1),
(3, 'černoch', 2),
(4, 'hlupák', 1),
...
CREATE TABLE `comments` (
  ...
  `bad_words` int(11) NOT NULL DEFAULT 0,
  `racist_words` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `comments` (`id`, `name`, `email`, `comment`, `Post_id`, `bad_words`, `racist_words`) VALUES
(131, 'Jana', 'janan@gmail.com', 0x41686f6a746520616b6f207374653f, 14, 0, 0),
(136, 'Velibor', 'velibor.jerotic@gmail.com', 0x646f62726520736d6520612076793f, 14, 0, 0);
...
INSERT INTO `users` (`id`, `admin`, `username`, `email`, `password`, `created_at`, `is_banned`, `ban_until`) VALUES
(22, 1, 'Velibor', 'velibor.jerotic@gmail.com', '$2y$10$HqKbrRQOSCn9rN797/R4kO3BwEsMW3wGiv8Ta0x5JXPyBrz54B5Fu', '2019-11-27 07:08:45', 0, NULL),
(37, 1, 'Jana', 'janan@gmail.com', '$2y$10$oZQuivfq6EfUAg2OGL5yi.VDXUlsuPCkAPDUEcucQqu3tQi2ZUuhG', '2021-04-08 20:19:04', 0, NULL),
(64, 0, 'HALO', 'halo@halo.com', '$2y$10$dtj9AtU7sTbsOTj.BLCIy.KnR8sa4LzeMBlDWWfXLrEXotJv0p/uq', '2021-04-12 02:21:17', 1, '2021-04-13 04:58:44'),
(75, 0, 'asd', 'aaa@aaaaa.com', '$2y$10$jVlHAU2hKUh02I72qjvTw.sdicQLewJRCuuHvTyf0qiTjTr8qEY7C', '2021-04-12 03:55:58', 1, '2021-04-13 06:24:34'),
(76, 0, 'Mila', 'janananika@gmail.com', '$2y$10$A8Z9eN5/Pjpn2TEa01OWo.dVLpbjgRlqjIIHoWm.iHidZfSzrik0K', '2021-04-12 06:53:18', 1, '2021-04-13 08:53:32');
